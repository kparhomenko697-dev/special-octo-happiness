...
date_time = datetime.datetime(202,
                              3,
                              7,
                              hour=16,
                              minute=17,
...
date_1 = datetime.date(202, 3, 7)
date_2 = datetime.date(16, 30, 45,1582)
...
print(f"date to int:{date_now.strftime('%d_%m_%Y %A %B')}")
print(f"date to int:{date_now.strftime('%H.%M.%S')}")
